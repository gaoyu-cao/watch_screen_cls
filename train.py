...
LastEditTime: 2021-08-25 03:13:43
'''
import os
...
from utils.WarmUpCosineDecayScheduler import WarmUpCosineDecayScheduler
...
def train(args):
    ...
    warm_up_lr = WarmUpCosineDecayScheduler(learning_rate_base=args.base_lr,
    ...
    # optimizer = Nadam(lr=args.base_lr, beta_1=0.9, beta_2=0.999, epsilon=1e-08, schedule_decay=0.004)
