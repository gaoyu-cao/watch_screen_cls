...
LastEditTime: 2021-08-23 03:11:01
'''
import os
os.environ['TF_CPP_MIN_LOG_LEVEL'] = '3' 
import tensorflow as tf 
import numpy as np
from models.mobilenetv3 import HTCMobileNetv3_small, HTCMobileNetv3_large
...
def train(args):
    ...
    model.fit(train_loader, epochs=epochs, callbacks=callbacks, validation_data=val_loader,workers=16)
